      ...
      <nav className="grid grid-cols-1 place-items-start max-md:mt-[1.5rem]">
        ...
        <RadioButtonGroup activeContentState={activeContentState} group={group} label={"Menu"}>
          <RadioButton value={"Overview"}>
            <svg width="0.8rem" height="0.8rem" viewBox="0 0 97 97" xmlns="http://www.w3.org/2000/svg">
          ...
          <RadioButton value={"History"}>
            <svg width="0.8rem" height="0.8rem" viewBox="0 0 86 108" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <RadioButton value={"Account"}>
            <svg width="0.8rem" height="0.8rem" viewBox="0 0 50 60" xmlns="http://www.w3.org/2000/svg">
